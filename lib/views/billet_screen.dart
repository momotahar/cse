  ...
  Future<void> _confirmDelete(BuildContext context, Billet b) async {
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text('Supprimer le billet « ${_ucFirst(b.libelle)} » ?'),
        actions: [
          TextButton(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final b = Billet(
                id: billet?.id,
                libelle: _ucFirst(libelle.text.trim()),
...
/// Formatter pour ne mettre en majuscule que la première lettre
class CapitalizeFirstTextFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    final cap = text[0].toUpperCase() + text.substring(1);
