...
class _DepensesListScreenState extends State<DepensesListScreen> {
  // Accent “marque” optionnel — le thème prend la main pour le reste
  ...
  /// Décoration unifiée des champs (pilotée par le thème)
        ...
        builder: (ctx, setLocal) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<int?>(
                value: selYear,
                decoration: _decField(ctx, label: 'Année', icon: Icons.event),
                items: years
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // laissez le thème gérer le fond (clair/sombre)
      body: Column(
        children: [
          // Filtres
          Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: cs.secondary.withOpacity(.24)),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          Text(
            label,
            style: TextStyle(fontWeight: FontWeight.w600, color: cs.secondary),
          ),
        ],
      ),
    );
